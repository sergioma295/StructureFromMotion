...
public:
    ...
    void setupUi(QMainWindow *PaginaPrincipal)
    {
        ...
        PaginaPrincipal->resize(600, 660);
        ...
        pb_Run->setGeometry(QRect(500, 590, 89, 25));
...
""));
        ...
        F1_Usuario->setGeometry(QRect(10, 50, 581, 71));
        ...
        F2_Camara->setGeometry(QRect(10, 130, 581, 71));
        ...
        value_cb_CamaraId->setFocusPolicy(Qt::StrongFocus);
        value_cb_CamaraId->setAutoFillBackground(false);
        value_cb_CamaraId->setStyleSheet(QString::fromUtf8("color: black;"));
        value_cb_CamaraId->setMaxVisibleItems(5);
        lb_CamaraId->raise();
        value_cb_CamaraId->raise();
        lb_CamaraIcon->raise();
        F4_Comentarios = new QFrame(centralwidget);
        F4_Comentarios->setObjectName(QString::fromUtf8("F4_Comentarios"));
        F4_Comentarios->setGeometry(QRect(10, 350, 581, 221));
        ...
        F3_Chessboard->setGeometry(QRect(10, 210, 581, 131));
